...
public class Crew extends BaseObservable implements Serializable {
    ...
    @SerializedName("job") String job;

    @SerializedName("also_known_as") List<String> also_known_as;
...
//    @SerializedName("tv_credits") String tv_credits;
    ...
    public void setJob(String job) {
        this.job = job;
        this.notifyPropertyChanged(BR.job);
    }
